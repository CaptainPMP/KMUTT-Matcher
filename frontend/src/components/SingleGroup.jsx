...
import { getSender, getSenderFull } from "../config/GroupLogics";
...
const SingleGroup = ({ fetchAgain, setFetchAgain }) => {
  ...
  useEffect(() => {
    socket.on("message recieved", (newMessageRecieved) => {
      if (
        ...
        selectedChatCompare._id !== newMessageRecieved.group._id
      ) {
          ...
          >
            ...
            {messages &&
              (!selectedChat.isGroupChat ? (
                ...
                <>
                  {selectedChat.group_name.toUpperCase()}
          ...
          >
            {loading ? (
              ...
              <div className="messages">
                <ScrollableGroup messages={messages} />
              </div>
            )}
